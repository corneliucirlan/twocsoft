	...
	<section class="card hoverable col s12 m12 l12">
		<div class="card-content">
			...
			<article class="col m12">
				<h3 class="center-align">Web Developer &#64; Uncover Romania Tours</h3>
				<div>
					<p class="center-align">2015 - present</p>
			...
			<article class="col m12">
				<h3 class="center-align">Owner &#64; Corneliu C&icirc;rlan PFA</h3>
				<div>
					<p class="center-align">2013 - present</p>
			...
			<article class="col m12">
				<h3 class="center-align">Co-founder &amp; Web Developer &#64; Uncover Romania</h3>
				<div>
					<p class="center-align">2012 - present</p>
